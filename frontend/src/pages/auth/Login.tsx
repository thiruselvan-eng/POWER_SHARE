...
const Login: React.FC = () => {
  ...
  const handleDemoSignIn = async (role: 'ROLE_BUYER' | 'ROLE_SELLER' | 'ROLE_ADMIN') => {
    setIsLoading(true);
    setServerError('');
    try {
      ...
      >
        ...
        <div className="relative bg-slate-900/90 border border-slate-800/80 rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">Sign in to buy or sell renewable energy</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#050816] border border-slate-800 text-white placeholder-slate-600 rounded-xl pl-10 pr-4 py-3 text-xs focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
                />
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-emerald-400 text-xs font-semibold hover:text-emerald-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#050816] border border-slate-800 text-white placeholder-slate-600 rounded-xl pl-10 pr-11 py-3 text-xs focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="bg-[#050816] hover:bg-emerald-500/10 border border-slate-800 hover:border-emerald-500/35 text-slate-300 hover:text-emerald-400 text-xs font-semibold py-2.5 px-2 rounded-xl transition-all duration-200 active:scale-95 text-center flex items-center justify-center gap-1 disabled:opacity-50"
              >
                🚀 Buyer
              </button>
              <button
